                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                        ...
                        <a href="{{ route('admin.request.details', Crypt::encrypt($request->id)) }}" class="text-secondary font-weight-bold text-xs mx-5" data-toggle="tooltip" data-original-title="Edit user">
                            Detay
                        </a>
