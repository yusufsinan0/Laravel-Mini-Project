        ...
        <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
              <h6 class="text-white text-capitalize ps-3 text-center">İşleme Alınan  Talepler</h6>
            </div>
          </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="align-middle text-center ">
                        ...
                        @if($request->status == "işleme alındı")
                            <span class="badge badge-sm bg-gradient-primary">İşleme Alındı</span>
                    ...
                    <td class="align-middle">
                        ...
                        <a href="{{route('admin.request.details', ['requestId'=>$request->id])}}"  class="text-secondary font-weight-bold text-xs mx-5" data-toggle="tooltip" data-original-title="Edit user">
                            Detay
                      </a>
                    </td>
                  </tr>
